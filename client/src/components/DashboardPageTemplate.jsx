            ...
            <div className="flex-1 h-fit flex flex-col pb-[3em]">
                ...
                <div className="pt-[2em] bg-blue-500 border-t border-white border-t-[0.1px]">
                    ...
                    <div className="flex px-5 gap-4 flex-col md:flex-row mt-5">
                        <DashboardBox title={box1} value={box1Value} Icon={Box1Icon} isLoading={isLoading} />
                        <DashboardBox title={box2} value={box2Value} Icon={Box2Icon} isLoading={isLoading} />
                        <DashboardBox title={box3} value={box3Value} Icon={Box3Icon} isLoading={isLoading} />
                    </div>
                </div>
                ...
                <div className="px-5 pt-[3em] flex gap-[2em] relative flex-col">
                    ...
                    <div className="flex pt-[2em] gap-[2em] flex-col lg:flex-row w-[100%]">
                        {isLoading ? (
                            <div className="w-[100%] lg:w-[50%] rounded-[5px] h-[350px] shadow z-1 bg-white">
                                <div className="bg-gray-200 animate-pulse w-[100%] h-[100%] p-[1.4em] rounded-[5px]"></div>
                            </div>
                        ): (
                    ...
                    {isLoading ? (
                        <div className="w-[100%] rounded-[5px] shadow h-[350px] z-1 bg-white">
                            <div className="bg-gray-200 animate-pulse w-[100%] h-[100%] p-[1.4em] rounded-[5px]"></div>
                        </div>
                    ): (
