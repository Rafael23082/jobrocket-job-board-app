...
function ApplicantCard({applicant, jobID, refetch, isLoading}){
    ...
    return(
        isLoading ? (
            <div className="flex items-start md:items-center flex-col md:flex-row relative py-[1.5em] border-b border-gray-200 relative gap-x-[2em]" style={{fontFamily: "'Roboto', sans-serif"}}>
                <div className="grow">
                    <div className="flex items-start md:items-center flex-col md:flex-row md:ml-0">
                        <div className="w-[50px] h-[50px] bg-gray-200 animate-pulse rounded-[10px] shrink-0"></div>
                        <div className="grow md:pl-[2em] pl-0">
                            <span className="block font-bold text-[1.1rem] mt-[1em] md:mt-0 text-gray-200 bg-gray-200 animate-pulse">placeholder</span>
                            <p className="text-[0.9rem] mt-[0.5em] md:mt-[0.2em] text-gray-200 bg-gray-200 animate-pulse">placeholder</p>
                            <span className="text-[0.9rem] text-gray-200 mt-[0.5em] md:mt-[0.2em] flex gap-x-[0.3em]">
                                <p className="bg-gray-200 animate-pulse">placeholder</p> <p className="bg-gray-200 animate-pulse">placeholder</p>
                            </span>
                            <p className={`text-[0.9rem] mt-[0.5em] md:mt-[0.2em] text-gray-200 bg-gray-200 animate-pulse`}>placeholder</p>
                        </div>
                    </div>
                </div>
                <button className={`text-gray-200 bg-gray-200 animate-pulse px-[1.4em] py-[0.6em] rounded-[10px] text-[0.88rem] font-semibold whitespace-nowrap mt-[1.2em] md:mt-0`}>Download Resume</button>
            </div>
        ): (
