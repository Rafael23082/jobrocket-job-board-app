    ...
    return(
        <>
            <div className="flex w-[100%] box-border font-medium justify-between items-center py-[1em] relative" style={{fontFamily: "'Roboto', sans-serif"}}>
                <p className="text-[2rem] font-bold text-[#3B82F6] pl-10 select-none" style={{fontFamily: "'Raleway', sans-serif"}}>JobRocket</p>
                ...
                {menuOpen ? (
                    <IoClose size={30} className="block lg:hidden cursor-pointer mr-10" color="#3B82F6" onClick={() => {setMenuOpen(!menuOpen)}} />
                ): (
                    <IoMdMenu size={30} className="block lg:hidden cursor-pointer mr-10" color="#3B82F6" onClick={() => {setMenuOpen(!menuOpen)}} />
                )}
                <div className={`${menuOpen ? "max-h-[500px]": "max-h-0"} transition-height duration-300 ease absolute w-[100%] bg-white top-[100%] z-20 lg:hidden select-none overflow-hidden`}>
                    <div className="py-[0.5em] pt-[1em] pl-10 cursor-pointer">Overview</div>
                    <div className="py-[0.5em] pl-10 cursor-pointer">Jobs</div>
                    <div className="py-[0.5em] pl-10 cursor-pointer">Pricing</div>
                    <div className="flex px-10 py-[0.5em] pb-[2em]">
