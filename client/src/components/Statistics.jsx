function Statistics(){
    return(
        <div className="flex flex-col lg:flex-row justify-around font-bold max-w-[1300px] mx-auto text-white py-[5em] md:py-[7em] text-[1rem] lg:text-[1.5rem]" style={{fontFamily: "'Roboto', sans-serif"}}>
